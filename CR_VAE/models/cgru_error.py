...
from CR_VAE.metrics.visualization_metrics import visualization
...
def train_phase2(crvae, vrae, X, context, lr, max_iter, lam=0, lam_ridge=0,
                     lookback=5, check_every=50, verbose=1,sparsity = 100, batch_size = 1024, plot=False):
    wandb.init(project = 'CR-VAE')
...
########################################################################   
    ...
    for it in tqdm(range(max_iter)):
        ...
        if (it) % check_every == 0:
            ...
            wandb.log({
                'phase_2/Loss':mean_loss,
                'phase_2/KL':mmd,
                'phase_2/Loss_e':smooth_e,
                'phase_2/KL_e':mmd_e
                        })
